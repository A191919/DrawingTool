...
{
    public sealed partial class AnnotDrawingToolBar : ToolStrip
    {
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] public
            ToolStripButton uiPrintButton;

        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] public
            ToolStripButton uiSaveButton;
        ...
        public byte DrawFillAlpha
        {
            get { return byte.Parse(uiSetFillAlphaTextBox.Text); }
        }

        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public Color DrawFillColor
        {
            get { return uiSetFillColorButton.BackColor; }
        }

        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public AnnotationLayer DrawLayer
        {
            get { return (AnnotationLayer) uiSetLayerComboBox.SelectedItem; }
        }

        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public LimitType DrawLimitType
        {
            get { return (LimitType) uiSetTypeComboBox.SelectedItem; }
        }

        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public byte DrawLineAlpha
        {
            get { return byte.Parse(uiSetLineAlphaTextBox.Text); }
        }
        ...
        {
            get { return uiSetLineColorButton.BackColor; }
        }

        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public LineStyle DrawLineStyle
        {
            get { return (LineStyle) uiSetLineStyleComboBox.SelectedItem; }
        }

        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public double DrawLineThickness
        {
            get { return double.Parse(uiSetLineThicknessTextBox.Text); }
        }
        ...
        {
            get { return uiSetTextTextBox.Text; }
        }
